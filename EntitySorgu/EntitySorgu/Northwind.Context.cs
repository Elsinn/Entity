...
namespace EntitySorgu
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public DbSet<vw_MondayShipping> vw_MondayShipping { get; set; }
        public DbSet<vw_ortalamafiyatustu> vw_ortalamafiyatustu { get; set; }
        ...
        public virtual ObjectResult<prc_katagorilist_Result> prc_katagorilist(string kategoriadi)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<prc_katagorilist_Result>("prc_katagorilist", kategoriadiParameter);
        }
    
        public virtual int prc_KategoriEkle(string kategoriadi, string kataciklama)
        {
            var kategoriadiParameter = kategoriadi != null ?
                new ObjectParameter("kategoriadi", kategoriadi) :
                new ObjectParameter("kategoriadi", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("prc_KategoriEkle", kategoriadiParameter, kataciklamaParameter);
        }
